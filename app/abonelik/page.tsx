  ...
  return (
    <div className="min-h-screen">
      <div className="py-20 px-8 text-center relative overflow-hidden" style={{background:'linear-gradient(to bottom, #0d1b3e, #080f22)'}}>
        ...
        <h1 className="font-display text-[clamp(40px,5vw,68px)] font-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-16">
          {PLANLAR.map(plan => (
            <div key={plan.slug} onClick={() => setSecili(plan.slug)}
              ...
              {(plan as any).one && <div className="absolute top-0 right-5 gradient-bg text-white text-[7px] tracking-[0.25em] uppercase px-3 py-1 rounded-b-xl font-bold">Popüler</div>}
