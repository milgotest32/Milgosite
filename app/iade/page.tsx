  ...
  return (
    <div style={{minHeight:'100vh',background:'#F0EEF8',padding:'48px 24px'}}>
      <div style={{maxWidth:'720px',margin:'0 auto',background:'#fff',borderRadius:'24px',padding:'48px',border:'1px solid #F0ECF5'}}>
        ...
        {[['İade Koşulları','Gıda ürünleri olmaları nedeniyle ürünlerimiz, teslim sonrasında açılmamış ve bozulmamış olmaları koşuluyla 24 saat içinde iade kabul edilir.'],['İade Süreci','İade talebinizi bilgi@milgo.com.tr adresine veya (0212) 352 10 76 numaralı telefona bildirin. İade kurye ücretini biz karşılıyoruz.'],['Geri Ödeme','Onaylanan iadeler 3-5 iş günü içinde kartınıza iade edilir. Havale ile ödeyenlerin banka bilgilerini iletmesi gerekmektedir.']].map(([h,p])=>(
