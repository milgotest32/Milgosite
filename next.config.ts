...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/products/siyah-zeytinli-ve-kekikli', destination: '/urun/siyah-zeytinli-ve-kekikli', permanent: true },
      { source: '/products/sarimsakli-kekikli', destination: '/urun/sarimsakli-kekikli', permanent: true },
      { source: '/collections/all', destination: '/urunler', permanent: true },

      // Blog / Tarifler
      { source: '/blogs/tarifler/lavasli-tereyagli-mini-gozlemee', destination: '/blog/lavasli-tereyagli-mini-gozlemee', permanent: true },
      { source: '/blogs/tarifler/milgo-cig-sut-ile-sutlac', destination: '/blog/milgo-cig-sut-ile-sutlac', permanent: true },
